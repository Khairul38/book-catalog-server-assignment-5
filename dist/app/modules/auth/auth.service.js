...
const createUserToDB = (user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (createdUser) {
        ...
        const accessToken = (0, jwtHelpers_1.createToken)({ _id, role, email, name }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
        const refreshToken = (0, jwtHelpers_1.createToken)({ _id, role, email, name }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
        return {
            accessToken,
            refreshToken,
        };
...
const loginUserFromDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isUserExist) {
        throw new apiError_1.ApiError(http_status_1.default.NOT_FOUND, "User does not exist with this email");
    }
