...
exports.deleteSingleCowFromDB =
  exports.updateSingleCowToDB =
  exports.getSingleCowFromDB =
  exports.getAllCowFromDB =
  exports.createCowToDB =
    void 0;
...
const getAllCowFromDB = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateSingleCowToDB = (user, id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // handle seller authorization
    if (user) {
      const authorizedSeller = yield cow_model_1.Cow.findOne({
        _id: id,
        seller: user._id,
      });
      if (!authorizedSeller) {
...
const deleteSingleCowFromDB = (user, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (user) {
      const authorizedSeller = yield cow_model_1.Cow.findOne({
        _id: id,
