...
exports.refreshTokenAdminFromDB =
  exports.updateAdminProfileToDB =
  exports.getAdminProfileFromDB =
  exports.loginAdminFromDB =
  exports.createAdminToDB =
    void 0;
...
const loginAdminFromDB = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getAdminProfileFromDB = admin =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admin_model_1.Admin.findById(
      admin === null || admin === void 0 ? void 0 : admin._id
    );
    if (result) {
      return result;
    } else {
...
const updateAdminProfileToDB = (admin, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { name } = payload,
      adminData = __rest(payload, ["name"]);
    if (adminData.phoneNumber) {
      const isExist = yield admin_model_1.Admin.findOne({
    ...
    if (adminData.password) {
      updatedAdminData.password = yield bcrypt_1.default.hash(
        adminData.password,
...
const refreshTokenAdminFromDB = token =>
  __awaiter(void 0, void 0, void 0, function* () {
    //verify token
